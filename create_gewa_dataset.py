...
import tqdm
from acronym_utils import extract_sample_info_from_basename, load_file_names, extract_sample_info, find_appraoch_score_target, create_point_close_grasp_list_and_approach_scores
import h5py
...
def save_contactnet_split_samples(data_dir, num_mesh, dataset_name="approach", radius=0.005):
    ...
    dataset_name = f"gewa_csplit_{dataset_name}"
