...
from utils.visualize_acronym_dataset import visualize_grasp, visualize_gt_and_pred_gasp
import argparse
import wandb
...
if __name__ == "__main__":
    ...
    downloaded_model_path = run.use_model(name="ApproachNet_nm_4000__bs_64_epoch_1500.pth:v0")
    print(downloaded_model_path)

    model_path = downloaded_model_path

    # load the GraspNet model and run inference then display the gripper pose
    model = ApproachNet(global_feat_dim=1024, grasp_dim=9)
